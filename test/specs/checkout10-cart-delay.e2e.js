...
describe('UserStory: Checkout', () => {
    ...
    // State machine info:
    // X 1 A 2 4 B 14(Logout) Y 1(Login) A 4 B 6 C 9 D 12 E
    it("TestCase_9: (TestCase_2 modified) should be able to add one item to cart, go to Cart page, logout, log back in and check it out successfully", async ()=>{ 
        ...
        stepnum += 3;
        console.log(`TestCase_9: S${stepnum} Logged in`)
 
        await CartPage.addItemToCart('#add-to-cart-sauce-labs-backpack');
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} Added item to cart`);
        ...
        await InventoryPage.ensureOnPage();
        stepnum += 2;
        console.log(`TestCase_9: S${stepnum} InventoryPage.ensure`);
        await CartPage.checkNumCartItems(1);
        ...
        await CartPage.checkNumCartItems(1);
        stepnum += 4;
        console.log(`TestCase_9: S${stepnum} Checked 1 item in cart, clicked on Cart Icon,ensured On CartPage`);
        ...
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} Logged out from Cart Page`);
        ...
        await LoginPage.login(LoginData.userName, LoginData.password);
        stepnum += 2;
        console.log(`TestCase_9: S${stepnum} Logged in again`);
        ...
        stepnum += 4;
        console.log(`TestCase_9: S${stepnum} Clicked on Checkout from CartPage`);
        
        await CheckoutStep1Page.ensureOnPage();
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} Ensured on CheckoutStep1Page`);
 
        await CartPage.checkNumCartItems(1);
 
        await CheckoutStep1Page.fillInCustomerInfo("Jane", "Doe", "90210");
        stepnum += 2;
        console.log(`TestCase_9: S${stepnum} CheckoutStep1Page: Filled in customer info`);
        
        await CheckoutStep1Page.clickOnContinue();
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} CheckoutStep1Page: Clicked on Continue`);    
        
        await CheckoutStep2Page.ensureOnPage();
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} CheckoutStep2Page: ensure on page`);    
        ...
        stepnum += 2;
        console.log(`TestCase_9: S${stepnum} CheckoutStep2Page: Clicked on Finish`);    
         
        await CheckoutCompletePage.ensureOnPage();
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} CheckoutCompletePage: ensureOnPage`); 
        await CartPage.checkNumCartItems(0);
        stepnum += 1;
        console.log(`TestCase_9: S${stepnum} END`);
    })
